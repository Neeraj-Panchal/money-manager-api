...
public interface IncomeRepository extends JpaRepository<IncomeEntity,Long> {
    ...
    //select * form tbl_incomes where profile_id = ?1 and date between ?2 and ?3 and name like %?4%
    ...
    //select * form tbl_incomes where profile_id = ?1 and date between ?2 and ?3
