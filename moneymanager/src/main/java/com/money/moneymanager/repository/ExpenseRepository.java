...
public interface ExpenseRepository extends JpaRepository<ExpenseEntity,Long> {
    ...
    //select * form tbl_expenses where profile_id = ?1 and date between ?2 and ?3 and name like %?4%
    ...
    //select * form tbl_expenses where profile_id = ?1 and date between ?2 and ?3
