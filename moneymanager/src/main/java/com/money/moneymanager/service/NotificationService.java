    ...
    public void sendDailyIncomeExpenseReminder(){
        ...
        for(ProfileEntity profile : profiles){
            String body = "Hi "+ profile.getFullName()+",<br><br>"
                    + "This i s a friendly reminder to add your income and expenses for today in Money Manager. <br><br>"
                    // Note the '...' around frontendUrl and the space before style
...
//                          <p>Hi %s,</p>
//                          <p>Here is a summary of your income and expenses for today:</p>
//                          %s
